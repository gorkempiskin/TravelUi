...
import 'package:ferhat_dur/models/popular_model.dart';
import 'package:ferhat_dur/models/recommended_model.dart';
import 'package:ferhat_dur/widgets/custom_tab_indicator.dart';
        ...
        child: Container(
          child: ListView(
            ...
            children: <Widget>[
                ...
                child: DefaultTabController(
                  ...
                  child: TabBar(
                      ...
                      tabs: [
                        ...
                        Tab(
                          child: Container(
                            child: Text('Yeni Hedefleriniz'),
                          ),
                        ),
                        Tab(
                          child: Container(
                            child: Text('Kesfedilmemis  Yerler'),
                          ),
                        )
                      ]),
                ),
              ...
              Padding(
                padding: EdgeInsets.only(top: 48, left: 28.8, right: 29),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
